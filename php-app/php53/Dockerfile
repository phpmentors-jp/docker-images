...
RUN apt-get install -y mysql-client-core-5.5
RUN apt-get install -y php5 php5-curl php5-intl php5-mysql php5-xdebug php-apc php5-dev
...
EXPOSE 80
ADD apache2/app.conf /etc/apache2/sites-available/default
...
ADD php5/app.ini /etc/php5/conf.d/90-app.ini
